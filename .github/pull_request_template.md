...
- [ ] Added unit tests for new logic (CI enforces 80% of changed executable lines in production-scope files (excludes Views (body via UITests) and Models/Logs) once the 10-line floor is met)
...
✅ **Code Coverage**: Enforces 80% minimum coverage on changed executable lines in production-scope files (excludes Views (body via UITests) and Models/Logs)
