...
| Debug `UIFileSharingEnabled`, `LSSupportsOpeningDocumentsInPlace` build settings | Expose DEBUG log files in the app’s Documents directory through Files and Finder without exposing Release documents. |
